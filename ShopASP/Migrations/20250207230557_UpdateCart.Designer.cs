...
namespace ShopASP.Migrations
{
    ...
    [Migration("20250207230557_UpdateCart")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShopASP.Models.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ShopASP.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("ShopASP.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ShopASP.Models.CartItem", b =>
                {
                    b.HasOne("ShopASP.Models.Cart", null)
                        .WithMany("CartItems")
                    ...
                    b.HasOne("ShopASP.Models.Photo", "ProductPhoto")
                        .WithMany()
